...
var CI_TOOL_JENKINS = 'jenkins';
var CI_TOOL_DRONE = 'drone';
var CI_TOOLS = [CI_TOOL_JENKINS, CI_TOOL_DRONE];
  ...
  writing: function() {
    ...
    switch (ciInfo.createci) {
      ...
      case CI_TOOL_JENKINS:
        ...
        break;
      default:
        feedback.warn('CI toolset ' + ciInfo.createci +
          ' is not currently available. Skipping CI script setup.');
        break;
    }
    if (file != '') {
      this.fs.copyTpl(
